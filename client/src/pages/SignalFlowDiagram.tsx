  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-12 dark:bg-slate-950">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <PatchFlowCanvas entities={Array.from(nodeMap.values())} selectedNodeId={selectedNodeId} traceRoles={traceRoles} focusedNodeIds={focusedNodeIds} focusEnabled={focusSelectedRoute} onSelectNode={setSelectedNodeId} onToggleFocus={() => setFocusSelectedRoute((current) => !current)} onClearFocus={clearSelectedPath} preferenceKey={`snapshot-${snapshotId}`} />
